...
public class PositionGraphTest {
  ...
  public void testPositions() {
    ...
    Position[] expectedPositions = { new Position(0, 0), new Position(1, 0), new Position(2, 0), new Position(1, 1),
        new Position(2, 1), new Position(2, 2) };
    PositionGraph graph = new PositionGraph(waitingTimes);
    assertEquals(expectedPositions.length, graph.getGraph().size());
